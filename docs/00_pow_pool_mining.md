# [![Trezarcoin](/images/tzcLogoPage_32x32.png "Trezarcoin")](https://trezarcoin.com) Pool Mining
...
[Here](https://github.com/Totenfluch/minerx/blob/master/MinerX/src/me/MinerX/Specs.java) are some configs for the NSGMiner ( Not all are up to date )
